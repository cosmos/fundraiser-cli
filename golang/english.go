...
var englishWordsMap = map[string]struct{}{}

func init() {
	englishWords := strings.Fields(englishWordsStr)
	for _, word := range englishWords {
		englishWordsMap[word] = struct{}{}
	}
}

// TODO: validate checksum
// TODO: validate length besides 12 words
...
const englishWordsStr = `abandon ability able about above absent absorb abstract
...
casual cat catalog catch category cattle caught cause caution cave ceiling
...
dove draft dragon drama drastic draw dream dress drift drill drink drip drive
drop drum dry duck dumb dune during dust dutch duty dwarf dynamic eager eagle
early earn earth easily east easy echo ecology economy edge edit educate effort
egg eight either elbow elder electric elegant element elephant elevator elite
else embark embody embrace emerge emotion employ empower empty enable enact end
...
race rack radar radio rail rain raise rally ramp ranch random range rapid rare
...
response result retire retreat return reunion reveal review reward rhythm rib
